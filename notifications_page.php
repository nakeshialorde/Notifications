...
<input type="hidden" name="requestsuccess" value="true" readonly>
												...
												//Requesting Party will receive
												<li class="list-group-item list-card list-card-slim">
												<label>Your account will be debited</label>
												<p style="color:red"> $<script type ="text/javascript">document.write(totalAmount);</script> </p>
												</li>
                        ...
                        <p><i><?php echo $_POST["optional"]; ?></i></p>
                                ...
                                <li class="list-group-item list-card list-card-slim">
                                    ...
                                    <div class="requestDetailRow">You will receive: <span id="totalFees" class="requestDetails theme-color-two"></span>
                                </li>
								</br>
