...
<form id="requestForm" action="requestfundsconfirmation.php" method="POST">
	...
	<label for="recipientInfoType">Recipient</label>
		<select class="form-control" id="recipientInfoType" name="recipientInfoType">
			<option value="EmailAddress" selected>Requesting Party: by Email Address</option>
			<option value="AccountNumber">Requesting Party: by Account #</option>
		</select>
	</div>
			...
			<!--<div id="thirdPartyAccountNoControl" class="control recipientOption" align="Left">
                ...
                <div class="control" align="left">
                    <div class="label"></div>-->
                    <input type="number" id="thirdPartyAccountNumber" name="thirdPartyAccountNumber" class="form-control" value=""/>
                <!--</div>	-->
				</div>


		<div id="RequesteeAccountNumber" class="form-group recipientOption">
		<label for="RequesteeAccountNumber">Requesting Party Account #</label>

		<!--<div id="thirdPartyAccountNoControl" class="control recipientOption" align="Left">
								<div class="label"><h3 style="color:green;">Third Party: Account #</h3></div>
							<div class="control" align="left">
									<div class="label"></div>-->
									<input type="number" id="RequesteeAccountNumber" name="RequesteeAccountNumber" class="form-control" value=""/>
							<!--</div>	-->
			</div>
			   ...
			   <div class="form-group">
                                            ...
                                            Charges applied
                                            <br> <i>  Request Fee : <span id="request-fee"> 2% of the request amount. </span> </i>
                                        </p>
                                    </div>
